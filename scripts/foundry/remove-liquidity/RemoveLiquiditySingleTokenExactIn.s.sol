...
// forge script scripts/foundry/remove-liquidity/RemoveLiquiditySingleTokenExactIn.s.sol --fork-url mainnet
contract RemoveLiquiditySingleTokenExactIn is Setup {
    function run() public {
        setupTokenBalances();
        ...
        uint256 amountOut = IRouter(router).removeLiquiditySingleTokenExactIn(
