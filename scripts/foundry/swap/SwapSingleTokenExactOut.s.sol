...
// forge script scripts/foundry/swap/SwapSingleTokenExactOut.s.sol --fork-url mainnet
contract SwapSingleTokenExactOut is Setup {
    function run() public {
        setupTokenBalances();
        ...
        uint256 amountIn = IRouter(router).swapSingleTokenExactOut(
